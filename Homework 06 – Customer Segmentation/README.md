...
![CS](./picture/K-mean_training.PNG)

## Evaluation
![CS](./picture/K-mean_evaluation.PNG)

## Scatter plot for less affluent customers
![CS](./picture/Less_affulent_customers.PNG)

## Scatter plot for middle class customers
![CS](./picture/Mid_market_customers.PNG)

## Scatter plot for upper-middle class customers
![CS](./picture/Up_market_customers.PNG)
